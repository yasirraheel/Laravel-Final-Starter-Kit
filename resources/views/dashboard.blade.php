            ...
            <div class="card mb-30 progress_1">
               <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap mb-2 progress-info">
                     <div>Users</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-up.svg') }}" alt="" class="svg"> 2.6k</div>
                  ...
                  <div class="d-flex flex-wrap progress-info">
                     ...
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-down.svg') }}" alt="" class="svg">25</div>
                  </div>
               </div>
            </div>
            <!-- End Card -->
         ...
         <div class="col-md-4 col-sm-6">
            ...
            <div class="card mb-30 progress_2">
               <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap mb-2 progress-info">
                     <div>Net Profit</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-up.svg') }}" alt="" class="svg"> 268k</div>
                  ...
                  <div class="d-flex flex-wrap progress-info">
                     <div>Expenses</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-up.svg') }}" alt="" class="svg">1.26k</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-down.svg') }}" alt="" class="svg">1.5k</div>
                  </div>
               </div>
            </div>
            <!-- End Card -->
         ...
         <div class="col-md-4 col-sm-6">
            ...
            <div class="card mb-30 progress_3 mr-0">
               <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap mb-2 progress-info">
                     <div>Employee</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-up.svg') }}" alt="" class="svg">15</div>
                  ...
                  <div class="d-flex flex-wrap progress-info">
                     <div>Production</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-up.svg') }}" alt="" class="svg">1.26k</div>
                     <div><img src="{{ asset('Dashmin_html/assets/img/svg/caret-down.svg') }}" alt="" class="svg">1.2k</div>
                  </div>
               </div>
            </div>
            <!-- End Card -->
               ...
               <div class="card-body p-0">
                     ...
                     <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <div class="d-flex align-items-center">
                           <a href="#" class="btn-circle">
                              <img src="{{ asset('Dashmin_html/assets/img/svg/plus_white.svg') }}" alt="" class="svg">
                           </a>
                  ...
                  <div class="single-row border-bottom pt-3 pb-3">
                     <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                           <!-- Drag Icon -->
                           <img src="{{ asset('Dashmin_html/assets/img/svg/dragicon.svg') }}" alt="" class="svg mr-2">
                           <!-- End Drag Icon -->
                           <!-- Assign To -->
                           <div class="assign_to">
                              <img src="{{ asset('Dashmin_html/assets/img/svg/Info.svg') }}" alt="" class="svg mb-1">
                           </div>
                           <!-- End Assign To -->
